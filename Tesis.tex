...
\end{align} Se desea estudiar el número de excitaciones del oscilador armónico, por lo que es necesario regresar a la notación de operadores usuales para oscilador armónico. Para este fin se toma la frecuencia del oscilador como una frecuencia promedio $\nu_0$. Con esto, los operadores $\Gamma$ pueden expresarse como:
