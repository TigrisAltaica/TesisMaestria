...
Se busca modelar interacciones que involucran un campo electromagnético el cual actúa como reservorio térmico, o baño. Esta interacción, con este sistema en particular corresponde a un superoperador de Lindblad de la forma \cite{EnglertDB}
...
\end{equation}Es importante notar que esto se obtiene en el cuadro de interacción, por lo que los valores finales deben incluir los valores propios de la parte correspondiente al Hamiltoniano sin pérdidas de energía.
...
\end{equation*} El cálculo de los otros dos conmutadores es completamente análogo, y se llega a
