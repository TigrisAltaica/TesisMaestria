...
\begin{equation}
H = -\hbar \delta a^{\dagger}a +\hbar\omega\Gamma^{\dagger}\Gamma +\frac{\hbar g'}{4\omega}(\alpha_0 a^{\dagger}+\alpha^*_0 a)(e^{i\omega t}\Gamma^{\dagger}+e^{-i\omega t}\Gamma)
...
\begin{equation}
L_1\rho= \frac{1}{i\hbar}[(\alpha_0 a^{\dagger}+ \alpha_0^* a)(e^{-i\omega t}\Gamma(t)+e^{i\omega t}\Gamma(t)^{\dagger}),\rho]
\end{equation} 
...
\begin{align*}
=&\frac{-1}{\hbar^2} Tr_c[L_1\frac{1}{\lambda_m - L_0}L_1 \rho_{st}\mu],\\
=&\frac{-1}{\hbar^2} Tr_c[L_1\frac{1}{\lambda_m - L_0}[Fx, \rho_{st}\mu]],\\
=&\frac{-1}{\hbar^2} Tr_c[L_1\frac{1}{\lambda_m - L_0}(Fx\rho_{st}\mu-\rho_{st}\mu Fx)],\\
=&\frac{-1}{\hbar^2} Tr_c[L_1\frac{1}{\lambda_m - L_0}x\mu F\rho_{st}]+\frac{1}{\hbar^2}Tr_c[L_1\frac{1}{\lambda_m - L_0}x\mu \rho_{st}F],\\
=&\frac{-1}{\hbar^2} Tr_c[[Fx,x\mu]\frac{1}{\lambda_m - L_0} F\rho_{st}]+\frac{1}{\hbar^2}Tr_c[[Fx,\mu x]\frac{1}{\lambda_m - L_0}\rho_{st}F],\\
=&\frac{-1}{\hbar^2} Tr_c[(Fxx\mu-x\mu Fx)\frac{1}{\lambda_m - L_0} F\rho_{st}]+\frac{1}{\hbar^2}Tr_c[(Fxx\mu-x\mu Fx)\frac{1}{\lambda_m - L_0}\rho_{st}F],\\
=&\frac{-1}{\hbar^2} Tr_c[F\frac{1}{\lambda_m - L_0}F\rho_{st}]xx\mu+\frac{1}{\hbar^2}Tr_c[F\frac{1}{\lambda_m - L_0}F\rho_{st}]x\mu x\\
