...
\begin{equation}
H(t)_{rad} = \frac{g}{-2i}\sqrt{\frac{\hbar^3}{2m}}  a^\dagger a[(\frac{\alpha (t) +1}{\beta(t)})\Gamma (t) +(\frac{\alpha (t) -1}{\beta(t)})\Gamma^\dagger (t)]
\end{equation}
...
\gamma_+(t)(t)=&\frac{\alpha (t) +1}{-2i\beta(t)},\\
\gamma_-(t)=&\frac{\alpha (t) -1}{-2i\beta(t)},
\end{align*} 
...
H_{rad}'=&-\hbar g\sqrt{\frac{\hbar^3}{2m}}[(a^{\dagger}a +\alpha a^{\dagger}+\alpha^* a + |\alpha|^2)(\gamma_+(t)(\Gamma^{\dagger}+\beta^*)+\gamma_-(t)(\Gamma+\beta))]\\
...
H =& -\hbar \delta(a^{\dagger}a +\alpha a^{\dagger}+\alpha^* a)+\frac{W}{|f(t)|^2}(\Gamma^{\dagger}\Gamma + \beta \Gamma^{\dagger} + \beta^* \Gamma)\\
 &-\hbar g\sqrt{\frac{\hbar^3}{2m}}[(a^{\dagger}a +\alpha a^{\dagger}+\alpha^* a + |\alpha|^2)(\gamma_+(t)(\Gamma^{\dagger}+\beta^*)+\gamma_-(t)(\Gamma+\beta))]\\
...
\begin{align}
a&(-\hbar\delta\alpha^* -\hbar g' \alpha^*(\gamma_+(t) \beta^* + \gamma_-(t) \beta)+ \frac{\hbar\Omega}{2} + i\hbar\dot{\alpha}^* -\hbar\frac{A}{2}\alpha^*),\\
a^\dagger&(-\hbar\delta\alpha -\hbar g' \alpha(\gamma_+(t) \beta^* + \gamma_-(t) \beta)+ \frac{\hbar\Omega}{2} - i\hbar\dot{\alpha} -\hbar\frac{A}{2}\alpha),\\
...
\end{align} lo cual genera ecuaciones diferenciales para los coeficientes $\alpha$ y $\beta$:
