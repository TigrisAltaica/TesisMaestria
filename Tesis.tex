...
\subsection{Proyectores a Escalas Temporales}
...
\begin{equation}
P\dot{\rho}(t) = PL_1Q\rho(t-\Delta t) + PL_1\int_{t_0}^{t}dt' QL_1(t')P\rho(t_0) + PL_1\int_{t_0}^{t}dt'QL_1(t')Q\rho(t_0),
\end{equation} donde únicamente sobrevive el último término. Regresando del cuadro de decaimiento:

\begin{equation}
P e^{-L_0 t}L_1e^{L_0 t}\int_{t_0}^{t}dt'Qe^{-L_0 t}L_1(t')e^{L_0 t}Pe^{-L_0 t}\rho(t_0)
\end{equation}
